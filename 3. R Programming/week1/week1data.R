...
good <-
c(TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, FALSE, 
...
structure(list(Ozone = c(41L, 36L, 12L, 18L, 23L, 19L, 8L, 16L, 
11L, 14L, 18L, 14L, 34L, 6L, 30L, 11L, 1L, 11L, 4L, 32L, 23L, 
45L, 115L, 37L), Solar.R = c(190L, 118L, 149L, 313L, 299L, 99L, 
19L, 256L, 290L, 274L, 65L, 334L, 307L, 78L, 322L, 44L, 8L, 320L, 
25L, 92L, 13L, 252L, 223L, 279L), Wind = c(7.4, 8, 12.6, 11.5, 
8.6, 13.8, 20.1, 9.7, 9.2, 10.9, 13.2, 11.5, 12, 18.4, 11.5, 
9.7, 9.7, 16.6, 9.7, 12, 12, 14.9, 5.7, 7.4), Temp = c(67L, 72L, 
74L, 62L, 65L, 59L, 61L, 69L, 66L, 68L, 58L, 64L, 66L, 57L, 68L, 
62L, 59L, 73L, 61L, 61L, 67L, 81L, 79L, 76L), Month = c(5L, 5L, 
5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 5L, 
5L, 5L, 5L, 5L, 5L, 5L), Day = c(1L, 2L, 3L, 4L, 7L, 8L, 9L, 
12L, 13L, 14L, 15L, 16L, 17L, 18L, 19L, 20L, 21L, 22L, 23L, 24L, 
28L, 29L, 30L, 31L)), .Names = c("Ozone", "Solar.R", "Wind", 
"Temp", "Month", "Day"), row.names = c(1L, 2L, 3L, 4L, 7L, 8L, 
9L, 12L, 13L, 14L, 15L, 16L, 17L, 18L, 19L, 20L, 21L, 22L, 23L, 
24L, 28L, 29L, 30L, 31L), class = "data.frame")
Mon6 <-
structure(list(Ozone = c(29L, 71L, 39L, 23L, 21L, 37L, 20L, 12L, 
13L), Solar.R = c(127L, 291L, 323L, 148L, 191L, 284L, 37L, 120L, 
137L), Wind = c(9.7, 13.8, 11.5, 8, 14.9, 20.7, 9.2, 11.5, 10.3
), Temp = c(82L, 90L, 87L, 82L, 77L, 72L, 65L, 73L, 76L), Month = c(6L, 
6L, 6L, 6L, 6L, 6L, 6L, 6L, 6L), Day = c(7L, 9L, 10L, 13L, 16L, 
17L, 18L, 19L, 20L)), .Names = c("Ozone", "Solar.R", "Wind", 
"Temp", "Month", "Day"), row.names = c(38L, 40L, 41L, 44L, 47L, 
48L, 49L, 50L, 51L), class = "data.frame")
